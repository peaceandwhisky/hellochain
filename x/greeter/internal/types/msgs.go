...
type MsgGreet struct {
	...
	Recipient sdk.AccAddress	// account designated as recipient of the greeting (not a signer)
}
...
// Type shoule return the action
func (msg MsgGreet) Type() string { "greet" }
...
// GetSignBytes encodes the message for signinig
