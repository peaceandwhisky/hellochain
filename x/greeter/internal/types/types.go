...
var (
	// ModuleCdc contains the types for module that require encodeing in amino
	ModuleCdc = codec.New()
)
...
type Greeting struct {
	...
	Recipient adk.AccAddress `json:"receiver" yaml:"receiver"`  // address of the account "receiving" the greeting
	Body string `json:"body" yaml:"body"` // string body of the greeting
}

// GreetingList stores all the greeting for a given address
...
type QueryResGretings map[string][]Greeting
